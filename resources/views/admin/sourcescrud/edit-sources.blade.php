            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="card mx-3">
                        ...
                        <div class="card-body">
                            <div class="container-fluid">
                                <form action="{{ route('admin.sources.edit.update', ['id_course' => $id_course, 'id_lesson' => $id_lesson, 'id_sources' => $sources->id]) }}" method="POST"
                                    ...
                                    <div class="col-12 me-3">
                                        ...
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="floatingInputGrid"
                                                placeholder="name@example.com" name="name_source" value="{{$sources->name_source}}">
                                    ...
                                    <div class="col-12 me-3 mt-3">
                                        ...
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="floatingInputGrid"
                                                placeholder="name@example.com" name="time_source" value="{{$sources->time_source}}">
                                    ...
                                    <div class="col-12 me-3 mt-3">
                                        ...
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="floatingInputGrid"
                                                placeholder="name@example.com" name="link_source" value="{{$sources->link_source}}">
